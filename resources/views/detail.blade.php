                            ...
                            <div class="swiper product-top">
                                ...
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide slider-top-img">
                                        <img src="{{asset('assets/images/homepage-one/product-img/product-img-14')}}'" alt="img">
                                    </div>
                                    <div class="swiper-slide slider-top-img">
                                        <img src="{{asset('assets/images/homepage-one/product-img/product-slider-img-1')}}'"
                                            alt="img">
                                    </div>
                                    <div class="swiper-slide slider-top-img">
                                        <img src="{{asset('assets/images/homepage-one/product-img/product-slider-img-2')}}'"
                                            alt="img">
                                    </div>
                                    <div class="swiper-slide slider-top-img">
                                        <img src="{{asset('assets/images/homepage-one/product-img/product-slider-img-3')}}'"
                                            alt="img">
                                    </div>
                                    <div class="swiper-slide slider-top-img">
                                        <img src="{{asset('assets/images/homepage-one/product-img/product-slider-img-1')}}'"
                            ...
                            <div class="swiper product-bottom">
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide slider-bottom-img">
                                        <img src="{{asset('assets/images/homepage-one/product-img/product-img-16.png')}}" alt="img">
                                    </div>
                                    <div class="swiper-slide slider-bottom-img">
                                        <img src="{{asset('assets/images/homepage-one/product-img/product-img-17.png')}}" alt="img">
                                    </div>
                                    <div class="swiper-slide slider-bottom-img">
                                        <img src="{{asset('assets/images/homepage-one/product-img/product-slider-img-2')}}'"
                                            alt="img">
                                    ...
                                    <div class="wrapper-aurthor">
                                        <div class="wrapper-info">
                                            <div class="aurthor-img">
                                                <img src="{{asset('assets/images/homepage-one/aurthor-img-1')}}'"
                                                    alt="aurthor-img">
                                            </div>
            ...
            <div class="weekly-sale-section">
                <div class="row g-5">
                    <div class="col-lg-3 col-md-6">
                        <div class="product-wrapper" data-aos="fade-up">
                            <div class="product-img">
                                <img src="{{asset('assets/images/homepage-one/product-img/product-img-5')}}'" alt="product-img">
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="product-wrapper" data-aos="fade-up">
                            <div class="product-img">
                                <img src="{{asset('assets/images/homepage-one/product-img/product-img-3')}}'" alt="product-img">
                                <div class="product-cart-items">
                                    <a href="#" class="cart cart-item">
                                        <span>
                                            <svg width="40" height="40" viewBox="0 0 40 40" fill="none"
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="product-wrapper" data-aos="fade-up">
                            <div class="product-img">
                                <img src="{{asset('assets/images/homepage-one/product-img/product-img-6')}}'" alt="product-img">
                                <div class="product-cart-items">
                                    <a href="#" class="cart cart-item">
                                        <span>
                                            <svg width="40" height="40" viewBox="0 0 40 40" fill="none"
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="product-wrapper" data-aos="fade-up">
                            <div class="product-img">
                                <img src="{{asset('assets/images/homepage-one/product-img/product-img-9')}}'" alt="product-img">
                                <div class="product-cart-items">
                                    <a href="#" class="cart cart-item">
                                        <span>
                                            <svg width="40" height="40" viewBox="0 0 40 40" fill="none"
