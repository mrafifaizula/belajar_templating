                    ...
                    <tr class="cart-top">
                            ...
                            <div class="wrapper-data">
                                ...
                                <div class="wrapper">
                                    <div class="wrapper-img">
                                        <img src="{{asset('assets/images/homepage-one/product-img/product-img-1.webp')}}" alt="">
                                    </div>
                        ...
                        <td class="cart-center cart-item">
                            <div class="wrapper-data">
                                ...
                                <div class="wrapper">
                                    <div class="wrapper-img">
                                        <img src="{{asset('assets/images/homepage-one/product-img/product-img-2.webp')}}" alt="">
                                    </div>
                                    <div class="wrapper-content">
                        ...
                        <td class="cart-center cart-item">
                            <div class="wrapper-data">
                                ...
                                <div class="wrapper">
                                    <div class="wrapper-img">
                                        <img src="{{asset('assets/images/homepage-one/product-img/product-img-3.webp')}}" alt="">
                                    </div>
                                    <div class="wrapper-content">
